...
Run the following regressions, and show them all, together in a nice looking table  
...
Then make sure that the output of the code for it doesn't show, this is just for you to see how R reacts to the multicolinearity problem.
...
*What happened in the output and why?*
...
* demonstrate that the residuals of model1 add up to zero. What does that mean?
...
* demonstrate the $R^2$ of a regression of the residuals of model1 on the original regressors must be zero. What does this mean?
